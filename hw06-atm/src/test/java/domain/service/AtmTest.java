...
class AtmTest {
    ...
    void getMoney1() {
        ...
        assertThat(atm.getStorage().getCellMap().get(500).size()).isEqualTo(4);
        assertThat(atm.getStorage().getCellMap().get(200).size()).isEqualTo(4);
        assertThat(atm.getStorage().getCellMap().get(100).size()).isEqualTo(4);
        assertThat(atm.getStorage().getCellMap().get(50).size()).isEqualTo(4);
    }
